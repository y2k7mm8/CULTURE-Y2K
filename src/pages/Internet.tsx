...
const websites: Website[] = [
  {
    ...
    hits: 15000,
    year: 1999,
    description: "Фан-сайт Y2K культуры с коллекцией веб-графики",
    popular: true,
  },
  {
    id: "w2",
    ...
    hits: 500000,
    year: 2000,
    description: "MSN Messenger - главный чат эпохи",
    popular: true,
  },
  {
    id: "w3",
    ...
    hits: 800000,
    year: 1999,
    description: "P2P музыкальный сервис, изменивший индустрию",
    popular: true,
  },
  {
    id: "w4",
    ...
    hits: 25000,
    year: 2000,
    description: "Библиотека Flash анимаций и эффектов",
  },
  {
    id: "w5",
    ...
    hits: 1000000,
    year: 2000,
    description: "AOL - крупнейший интернет-провайдер эпохи",
    popular: true,
  },
  {
    id: "w6",
  ...
  },
  {
    ...
    hits: 200000,
    year: 2003,
    description: "MySpace - первая социальная сеть",
    popular: true,
    titleKey: "MySpace",
  },
  {
    ...
    hits: 75000,
    year: 1999,
    description: "Виртуальные питомцы и игры",
  },
  {
    id: "w9",
    url: "winamp.com",
    ...
    hits: 50000,
    year: 1997,
    description: "Winamp - легендарный MP3 плеер",
    popular: true,
    titleKey: "Winamp",
  },
  {
    ...
    hits: 30000,
    year: 1999,
    description: "Бесплатный хостинг для личных сайтов",
  },
];

const internetFacts = [
  "Dial-up соединение со скоростью 56K было стандартом в 2000 году",
  "Баннеры 'Click here for free' были повсюду в эпоху Y2K",
  "Графика в стиле 'Web 1.0' использовала простые таблицы и GIF",
  "У каждого была страница на GeoCities с крутой обложкой",
  "Анимированные GIF были последним словом дизайна",
  "MSN Messenger чат-статус показывал 'Away' или 'Busy'",
  "Кнопки 'Add to Favorites' были на каждой странице",
  "Навигация была в виде sidebar с иконками и блестками",
];
...
export default function Internet() {
  ...
  const [filterStatus, setFilterStatus] = useState<"all" | "online" | "broken" | "slow">("all");
  const [filterCategory, setFilterCategory] = useState<"all" | "entertainment" | "social" | "tech">("all");
    ...
    <div className="space-y-5">
        ...
        <div className="chrome-panel rounded-[28px] p-6">
          <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-4">
            <div>
              ...
              <h1 className="window-title text-4xl text-white md:text-5xl">
                {t("internet.title")}{" "}
                <span className="chroma-text">{t("internet.titleHighlight")}</span>
              </h1>
          ...
          <div className="grid gap-3 md:grid-cols-3 mb-5">
            <div className="bg-white/5 rounded-lg p-3 text-center">
              <div className="text-2xl font-bold text-cyan-300">{onlineSites}</div>
      ...
      <section className="chrome-panel rounded-[24px] p-5 bg-gradient-to-r from-cyan-500/20 to-blue-500/20">
        <div className="flex items-start gap-4">
          ...
          <button
            onClick={() => setCurrentFact((prev) => (prev + 1) % internetFacts.length)}
      ...
      <section className="y2k-shell rounded-[30px] p-5">
        <div className="flex justify-between items-center mb-4">
          <p className="micro-label">Web Database</p>
          <p className="text-sm text-white/60">
            {visible.length} sites found
          </p>
        </div>
        ...
        <section className="chrome-panel rounded-[30px] p-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="mt-2 text-sm text-cyan-200 font-mono">{selectedSite.url}</p>
            </div>
            <button
